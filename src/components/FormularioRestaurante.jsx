...
const FormularioRestaurante = () => {
  ...
  return (
      ...
      <div id='restaurantes' className="bg-white min-h-screen text-white  px-4 flex justify-center items-center">
          ...
          <form onSubmit={handleSave} className="mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center">
                ...
                />
                <label className="block text-sm font-semibold">Pedido Entregado ? </label>
              </div>
            </div>
            <button type="submit" className="mt-6 bg-gray-700 text-white py-2 px-6 rounded-md hover:bg-blue-600 transition duration-300">
              {id ? 'Actualizar' : 'Guardar'}
            </button>
            <button
              onClick={() => navigate('/lista')}
              className="mt-8 text-white py-2 px-4 rounded-md hover:text-blue-600 transition duration-300"
            >
              SU LISTA DE PEDIDOS
            </button>
          </form>
